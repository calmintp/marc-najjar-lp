    ...
    <div class="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center gap-10 px-6 lg:flex-row lg:gap-16 lg:px-8">
        ...
        <div class="flex flex-1 flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <div class="mt-10 flex flex-col gap-4 sm:flex-row">
                <a href="{{ route('home') }}#free-guide" class="inline-flex items-center justify-center bg-primary px-10 py-4 text-base font-bold uppercase tracking-wider text-primary-foreground transition-colors hover:bg-gold-light">
                    Book Marc to Speak
                </a>
